...
while attemps < 12345677901:
    ...
    if username == 'KING' and password == 'mafuz':
...
os.system('espeak -a 300 " Welcome,   to,  MAFUZ,  King,  Tools"')
time.sleep(1)
...
def login():
	...
	if TARAK in ['m']:
		...
		os.system('xdg-open https://wa.me/+8801741605824')
	elif TARAK in ['0']:
...
def passwrd():
	...
	print("\033[1;92m  [~] Welcome To Tool MAFUZ Cracker")
	TARAKj(f'\033[0;97m===============================================')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[MAFUZ-💙] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
